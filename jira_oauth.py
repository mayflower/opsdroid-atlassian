...
class JiraOauth:
    def __init__(self):
        ...
        self.request_token_url = "{}/plugins/servlet/oauth/request-token".format(
            base_url
        )
    ...
    def accepted(self, state):
        ...
        return (
            access_token[b"oauth_token"].decode("utf-8"),
            access_token[b"oauth_token_secret"].decode("utf-8"),
        )
